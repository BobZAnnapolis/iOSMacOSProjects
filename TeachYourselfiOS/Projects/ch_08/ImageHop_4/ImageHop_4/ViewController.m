...
- (void)viewDidLoad
{
    ...
    // configure the images for animation
    //  cxreate an array and put the 20 image files into it
    ...
    // put the animation array into our views
    ...
    // set the duration, i.e., # seconds to display each animation
...
- (IBAction)toggleAnimation:(id)sender {
    ...
    //      stop it & change the button text
    if (self.bunnyView1.isAnimating) {
        ...
        [self.hopButton setTitle:@"Hop !" forState:UIControlStateNormal];
    }
    // else it is currently stopped
    //      start it & change the button text
    else {
        ...
        [self.hopButton setTitle:@"SitStill !" forState:UIControlStateNormal];
    }
}
...
- (IBAction)setSpeed:(id)sender {
    ...
    [self.hopButton setTitle:@"Sit Still !!" forState:UIControlStateNormal];
